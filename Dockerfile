...
# docker build -t supplier_registration .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name supplier_registration supplier_registration
